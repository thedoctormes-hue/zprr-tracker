...
os.makedirs("/root/LabDoctorM/protocol/data", exist_ok=True)

result1 = subprocess.run(
    ["sqlite3", "/root/LabDoctorM/protocol/data/protocol.db",
...
result3 = subprocess.run(
    ["sqlite3", "/root/LabDoctorM/protocol/data/protocol.db", "SELECT COUNT(*) FROM users;"],
    capture_output=True, text=True)

with open("/root/LabDoctorM/protocol/cleanup_output.txt", "w") as f:
